...
-   Background
    ...
    -   A focus on phenotype, survival data, and protein expression quantification.
-   Research Objective
...
-   **03_augment**
    ...
    -   Peptide target xpression mean variable
    
    -   Alcohol consumption as binomial variable
:::
...
#| eval: FALSE 
#| output: FALSE  
#| code-line-numbers: "|1-4|6-15|17-21|23-27"
