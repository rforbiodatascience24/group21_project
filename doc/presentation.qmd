...
-   **Download, name and data**
    ...
    -   Phenotype (n=604), survival data (n=603), protein Expression (n=354)

-   **Join tables**

    -   inner_join and pivot_longer
...
![](images/09_analysis_lm_volcano_alcohol.png)

## Analysis visual {.smaller}

::: columns
::: {.column width="50%"}
![](../results/images/barplot_vital_status_genders_facet_races.png){width="100%" height="400px"}
:::

::: {.column width="50%"}
![](../results/images/boxplot_years_smoked_vital_status_facet_pathological.png){width="100%" height="400px"}
:::
:::
