...
## Linear model vital status

```{r}
#| include: false

quarto::quarto_render(input = "../R/06_analysis_lm_vital_status.qmd",
                      output_format = "html")

file.rename(from = "../R/06_analysis_lm_vital_status.html",
            to = "../results/06_analysis_lm_vital_status.html")
```
...
quarto::quarto_render(input = "../R/00_all.qmd",
                      output_format = "html")
