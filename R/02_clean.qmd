...
To clean the dataset, we select the variables we want to work with and assign new names to the variables so they follow snake_case.\
The cleaned dataset is assigned to a new object.

```{r}
#| label: "choosing-variables-and-assigning-new-names"
