...
heatmap_selected_peptides <- expression_meta_data_analysis_1 |> 
...
heatmap_selected_peptides_1 <- expression_meta_data_analysis_1 |> 
...
# Calculate mean_expression and count for each group
mean_expression_5_year <- expression_meta_data_analysis_1 |> 
  filter(peptide_target %in% selected_peptides$peptide_target,
         !is.na(age_interval_5_year), 
         !is.na(expression),
         # Leaving out age intervals 15-19 and 20-24 as less than three represented
         !age_interval_5_year %in% c("15-19", "20-24")) |> 
  group_by(peptide_target, age_interval_5_year) |> 
  summarize(
    mean_expression = mean(expression, na.rm = TRUE),
