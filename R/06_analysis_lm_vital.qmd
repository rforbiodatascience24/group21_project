...
```{r}
#| label: "computing-CI-95-using-tidy-06"
...
Then we check if we have any proteins that are expressed significantly different, between the alive patients and the ones who have died.
...
Creating a forest plot for significant proteins using ggplot.
...
From the linear model it has been found that 6 proteins are expressed significantly different (with alpha of 5%) between patients who die from head and neck cancer and patients who do not. It would be interesting to further investigate the possible influence of these 6 proteins.
