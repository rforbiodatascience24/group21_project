...
# Linear model - Vital status: dead or alive
...
Term describes if the patient is dead or alive. 0 = alive and 1 = dead. Therefore the intercept is alive and the slope + intercept is dead.
