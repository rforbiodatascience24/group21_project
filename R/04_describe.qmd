...
-   Check tables before and after cleaning and augmentation.
    ...
    We can see that the columns changed.
...
-   Check the different pathologic stages and count how many patients are in each group
...
-   Count how many alive and dead patients
