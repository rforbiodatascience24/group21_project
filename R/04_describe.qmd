...
```{r}
#| label: "checking-number-of-columns" 
...
```{r}
#| label: "number-of-columns-in-data" 
...
```{r}
#| label: "pathologic-stage-distribution-plot" 
...
```{r}
#| label: "assing-mean-and-median-age" 
...
```{r}
#| label: "vital-status-age-distribution" 
...
```{r}
#| label: "check-number-of-peptides"
